package com.example.cus02demo.ui.theme
...
val backgroundPrincipal = Color(0xFF085394)
val textColor = Color(0xFF085394)
val backgroundCard = Color(0xFF162B4E)
...
val BackgroundComunesCard = Color(0xFFC1C1C1)
